...
<!-- Mirrored from demo.devitems.com/pander-v3/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Feb 2019 08:48:39 GMT -->
<head>
...
{ 
    ...
    {
        alert('veuillez verifier votre CIN');
        b_cin = false;
    }
        if( !isNaN(tel) )
    {
    ...
    if ( b_cin == true && b_nom == true && b_prenom == true && b_tel == true) 
    {
    ...
    <title>B&B ||Créer un compte</title>
...
if(isset($_SESSION['client']['username']))
 ...
 <?php 
        ...
        <div class="register-area ptb-90">
		    <div class="container">
            <h3 class="login-header">Créer un compte</h3>
		        <div class="row">
		            <div class="offset-xl-1 col-xl-10">
                        <div class="register-form login-form clearfix">
                            <form id="form" method="POST" action="client.php">
                                <p>Vous avez déjà un compte? <a href="login.php">Connectez-vous à la place!</a></p>
                                <div class="form-group row">
                                    <label for="f-name" class="col-lg-3 col-md-3 col-form-label">Nom</label>
                                    <div class="col-lg-6 col-md-6">
                                        <input type="text" name="nom" class="form-control" required=""  id="nom">
                                    </div>
                                </div>
                                 <div class="form-group row">
                                    <label for="f-name" class="col-lg-3 col-md-3 col-form-label">Prenom</label>
                                    <div class="col-lg-6 col-md-6">
                                        <input type="text" name="prenom" class="form-control" required="" id="prenom" >
                                    </div>
                                </div>
                                 <div class="form-group row">
                                    <label for="f-name" class="col-lg-3 col-md-3 col-form-label">CIN</label>
                                    <div class="col-lg-6 col-md-6">
                                        <input type="text" name="cin" id="cin" class="form-control" required="" >
                                    </div>
                                </div>
                                 <div class="form-group row">
                                    <label for="f-name" class="col-lg-3 col-md-3 col-form-label">Adress</label>
                                    <div class="col-lg-6 col-md-6">
                                        <input type="text" name="adress" class="form-control" required="" >
                                    </div>
                                </div>
                                 <div class="form-group row">
                                    <label for="f-name" class="col-lg-3 col-md-3 col-form-label">Nombre telephone</label>
                                    <div class="col-lg-6 col-md-6">
                                        <input type="Nombre" name="tel" class="form-control" required="" id="tel">
                                    </div>
                                </div>
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    <label for="l-name" class="col-lg-3 col-md-3 col-form-label">Nom d'utilisateur</label>
                                    <div class="col-lg-6 col-md-6">
                                        <input type="text" name="username" class="form-control" required="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputPassword" class="col-lg-3 col-md-3 col-form-label">Mot de passe</label>
                                    <div class="col-lg-6 col-md-6">
                                        <input type="password" name="password" class="form-control" required="" >
                                        <button class="btn show-btn" type="button" >montrer</button>
                                    </div>
                                </div>
                             <div class="form-group row">
                                    <label for="f-name" class="col-lg-3 col-md-3 col-form-label">Entrez le code</label>
                                    <div class="col-lg-6 col-md-6">
                                ...
                                <div class="register-box mt-40">
                                   <input type="button" class="login-btn float-right " value="Valider" onclick=" alphanumeric()"/>
                                </div>
                            </form>
                        </div>
		            </div>
