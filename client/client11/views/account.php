                                    ...
                                    <div class="register-form login-form clearfix">
                                        <form method="POST" action="client_Modifier.php">
                                             <div class="form-group row">
                                                <label for="l-name" class="col-lg-3 col-md-4 col-form-label">CIN</label>
                                                <div class="col-lg-6 col-md-8">
                                                    <input type="text" name="cin" class="form-control" value="<?php echo $_SESSION['client']['cin'] ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
...
<script type="text/javascript">
    function verif()
    {
        ...
        var cin=document.f.cintel.value;
