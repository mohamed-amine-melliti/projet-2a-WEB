...
<html class="fixed">
	<head>
		...
		<title>User Profile | B&B-Admin</title>
							...
							<section class="panel">
								<div class="panel-body">
									<div class="thumb-info mb-md">
										<img src="assets/images/!logged-user.jpg" class="rounded img-responsive" alt="Wajdi Khlifa">
										<div class="thumb-info-title">
											<span class="thumb-info-inner">Wajdi Khlifa</span>
							...
							<div class="tabs">
								...
								<div class="tab-content">
									...
									<div id="edit" class="tab-pane">
										...
										<form class="form-horizontal" method="POST" action="admin_Modifier.php">
...
$clientA=AdminC::nombreclient();
$clientO=AdminC::nombreclientO();
$clientD=AdminC::nombreclientD();
//var_dump($listeEmployes->fetchAll());
?>
						<div class="col-md-12 col-lg-3">

							<h4 class="mb-md">Stats sur les clients</h4>
							<ul class="simple-card-list mb-xlg">
								<li class="primary">
									<h3><?PHP echo $clientA['clientA']; ?></h3>
									<p>Nombre de client actif</p>
								</li>
								<li class="primary">
									<h3><?PHP echo $clientO['clientO']; ?></h3>
									<p>Nombre de client hors ligne</p>
								</li>
					            <li class="primary">
									<h3><?PHP echo $clientD['clientD']; ?></h3>
									<p>Nombre des comptes désactiver ou supprimer</p>
								</li>
								<li class="primary">
									<h3>$ 189,000.00</h3>
