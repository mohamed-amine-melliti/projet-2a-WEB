...
<html class="fixed">
	<head>
		...
		<title> Supprimer un compte  | B&B-Admin</title>
...
$notifications=ReclamationC::notificationsReclamation();
					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Gestion des clients</span></li>
								<li><span>supprimer un compte de client</span></li>
							</ol>
...
?>
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Liste des Reclamations</h2>
							</header>
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-editable">
									...
									<tbody>
										...
										<tr class="gradeX">
											...
											<td> 
											<a href="forms-validation client.php?id_reclamation=<?PHP echo $row['id_reclamation']; ?>"
												>Répondre</a></td>
				...
				<footer class="panel-footer">
					<div class="row">
						<div class="col-md-12 text-right">
							<form method="POST" action="supprimer_Reclamation.php">
