...
if (isset($_GET['codepromo'])){
	$offreC=new offreC();
    $result=$offreC->recupereroffre($_GET['codepromo']);
...
?>
									<form method="POST" >									
										...
										<div class="panel-body">
													...
													<label class="col-md-3 control-label">id offre</label>
													<div class="col-md-6">
                                                    <input type="number" class="form-control" name="codepromo" value="<?PHP echo $codepromo ?>">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-md-6">
                                                    <input type="text" class="form-control" name="descripition" value="<?PHP echo $descripition ?>">													</div>
												</div>
							
												<div class="form-group">
													<label class="col-md-3 control-label">date debut </label>
													<div class="col-md-6">
                                                    <input type="date" class="form-control" name="datedebut" value="<?PHP echo $datedebut ?>">													</div>
                                                </div>
                                                <div class="form-group">
														<label class="col-md-3 control-label">Pourcentage</label>
														<div class="col-md-6">
                                                        <input type="number" class="form-control" name="pourcentage" value="<?PHP echo $pourcentage ?>">														</div>
													</div>
							
                                                <div class="form-group">
													<label class="col-md-3 control-label">date fin </label>
													<div class="col-md-6">
                                                    <input type="date"  class="form-control" name="datefin" value="<?PHP echo $datefin ?>">													</div>
												</div>
...
<br>										
    ...
    <div>
                                                    <input type="hidden" name="codepromo_ini" value="<?PHP echo $_GET['codepromo'];?>">	
													</div>
...
if (isset($_POST['modifier'])){
	$offre=new offre($_POST['codepromo'],$_POST['descripition'],$_POST['datedebut'],$_POST['pourcentage'],$_POST['datefin']);
	$offreC->modifieroffre($offre,$_POST['codepromo_ini']);
    echo $_POST['codepromo_ini'];
    ?>
    <script> location.replace("afficheroffre.php"); </script>
<?PHP
}
?>
								</section>
