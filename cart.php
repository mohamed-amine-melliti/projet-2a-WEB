...
$panierC=new PanierC;
if (isset($_GET['id'])&&isset($_SESSION['client']['id_client']))
{
    $panierC->ajouterProduit($_SESSION['client']['id_client'],$_GET['id'],1);
}
if (isset($_GET['del'])&&isset($_SESSION['client']['id_client']))
{
    $panierC->supprimerProduit($_SESSION['client']['id_client'],$_GET['del']);
}
if (isset($_SESSION['client']['id_client']))
{
    $liste=$panierC->afficher($_SESSION['client']['id_client']);
}
?>
...
<!-- Mirrored from demo.devitems.com/pander-v3/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Feb 2019 08:48:43 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Cart || Pander Furniture Ecommerce Bootstrap 4 Template</title>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($liste as $p)
                                        {
                                            ...
                                            <td class="product-thumbnail">
                                                <a href="#"><img src="images/<?php echo $p['img'] ?>" alt="cart-image" /></a>
                                            </td>
                                            <td class="product-name"><a href="product-details.html"><?php echo $p['nom'] ?></a></td>
                                            <td class="product-price"><span class="amount"><?php echo $p['prix'] ?></span></td>
                                            <td class="product-quantity"><input type="number" value="<?php echo $p['qte'] ?>" /></td>
                                            <td class="product-subtotal"><?php echo $p['prix']*$p['qte'] ?></td>
                                            <td class="product-remove"> <a href="cart.php?del=<?php echo $p['id'] ?>"><i class="fa fa-times" aria-hidden="true"></i></a></td>
                                        </tr>
                                            <?php
                                        }
                                    }
