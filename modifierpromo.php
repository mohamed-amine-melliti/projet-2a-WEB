...
?>
									<form method="POST" >									
										...
										<div class="panel-body">
													...
													<label class="col-md-3 control-label">id promotion</label>
													<div class="col-md-6">
                                                    <input type="number" name="idpromo" value="<?PHP echo $idpromo ?>">
													</div>
												</div>
							
												<div class="form-group">
													<label class="col-md-3 control-label">Nom Promotion</label>
													<div class="col-md-6">
                                                    <input type="text" name="nompromo" value="<?PHP echo $nompromo ?>">													</div>
												</div>
							
												<div class="form-group">
													<label class="col-md-3 control-label">date debut </label>
													<div class="col-md-6">
                                                    <input type="text" name="datedebut" value="<?PHP echo $datedebut ?>">													</div>
                                                </div>
                                                <div class="form-group">
														<label class="col-md-3 control-label">Pourcentage</label>
														<div class="col-md-6">
                                                        <input type="number" name="pourcentage" value="<?PHP echo $pourcentage ?>">														</div>
													</div>
							
                                                <div class="form-group">
													<label class="col-md-3 control-label">date fin </label>
													<div class="col-md-6">
                                                    <input type="text" name="datefin" value="<?PHP echo $datefin ?>">													</div>
												</div>
												 <div class="form-group">
													<label class="col-md-3 control-label">image </label>
													<div class="col-md-6">
                                                    <input type="text" name="image" value="<?PHP echo $image ?>">													</div>
												</div>
...
<br>										
    ...
    <div>
                                                    <input type="hidden" name="idpromo_ini" value="<?PHP echo $_GET['idpromo'];?>">	
													</div>
...
if (isset($_POST['modifier'])){
    ...
    ?>
    <script> location.replace("afficherpromo.php"); </script>
<?PHP
}
?>
								</section>
