...
<select name="categorie">
																<option  value="accesoir">accesoir</option>
...
if (isset($_POST['modifier'])){
	$Produit=new Produit($_POST['idproduit'],$_POST['nomproduit'],$_POST['description'],$_POST['prix'],$_POST['qt'],$_POST['categorie'],$_FILES['image']['name']);
	$ProduitC->modifierProduit($Produit,$_POST['idproduit_ini']);
	echo $_POST['idproduit_ini'];
	?>
	<script> location.replace("afficherProduit.php"); </script>
	<?php
}
	?>
							...
							<div class="col-xs-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Ajouter Image de produit</h2>
									</header>
