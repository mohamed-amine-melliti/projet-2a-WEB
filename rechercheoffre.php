...
//Querry DB
  $sql="SELECT * FROM offres WHERE descripition LIKE '%" . $recherche . "%'";
//run query
  $result = $db->query($sql); 
//loop through results
  ...
  if($result)
  {
	...
	// on affiche les résultats
	 ...
	 //echo '<tr>';
     //                echo "<td align=center>".$data['codepromo']." </td>\n";
       //             echo "<td align=center>".$data['descripition']." </td>\n";
          //           echo "<td align=center>".$data['datedebut']." </td>\n";
            //         echo "<td align=center>".$data['datefin']." </td>\n";
              //       echo "<td align=center>".$data['pourcentage']." </td>\n";
                //     echo '</tr>';                                      <?PHP
                      
                      ?>
                  <tr class="gradeX">
                        
                        <td><?PHP echo $data['codepromo']; ?></td>
                        <td><?PHP echo $data['descripition']; ?></td>
                        <td><?PHP echo $data['datedebut']; ?></td>
                        <td><?PHP echo $data['pourcentage']; ?></td>
