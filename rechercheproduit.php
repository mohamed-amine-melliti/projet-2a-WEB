...
<html class="fixed search-results">
	<head>
		...
		<title>Searching Results | B&B-Admin</title>
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<div class="search-content">
						...
						<form method="POST" action="recherche.php" class="search nav-form">
					<div class="input-group input-search">
							<input type="text" class="form-control" name="srch" id="q" placeholder="Search...">
							<span class="input-group-btn">
						...
						<div class="search-toolbar">
							<ul class="list-unstyled nav nav-pills">
								<li class="active">
									<a href="#everything" data-toggle="tab">Produit Trouvé</a>
								</li>
						...
						<div class="tab-content">
							<div id="everything" class="tab-pane active">
								...
								<ul class="list-unstyled search-results-list">
									<li>
										<p class="result-type">
											<span class="label label-primary">produit</span>
										</p>
										<a href="#" class="has-thumb">
											<div class="result-thumb">
												<?PHP echo "<img  src='images/".$data['image']."'  >"; ?>
											</div>
											<div class="result-data">
												<p class="h3 title text-primary"><?PHP echo $data['nomproduit']; ?></p>
												<p class="description"><?PHP echo $data['description']; ?></p>
												<p class="description"><?PHP echo $data['categorie']; ?></p>

												<br>
												<h2><?PHP echo $data['prix']; ?> DT</h2>
											</div>
										</a>
									</li>
