		...
		<section class="body">
			...
			<header class="header">
				<div class="logo-container">
					<a href="../" class="logo">
						<img src="assets/images/logo.png" height="47" width="270" alt="Porto Admin"  />
					</a>
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<form method="POST" action="rechercheproduit.php" class="search nav-form">
					<div class="input-group input-search">
							<input type="text" class="form-control" name="srch" id="q" placeholder="Recherche par produit...">
							<span class="input-group-btn">
								<button class="btn btn-default"  name="submit" type="submit"><i class="fa fa-search"></i></button>
							</span>
						</div>
</form>
<form method="POST" action="recherchecategorie.php" class="search nav-form">
					<div class="input-group input-search">
							<input type="text" class="form-control" name="srch" id="q" placeholder="Recherche par categorie...">
							<span class="input-group-btn">
								<button class="btn btn-default"  name="submit" type="submit"><i class="fa fa-search"></i></button>
							</span>
						</div>
        ...
        switching = true;
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Les Produits</h2>
							</header>
...
?>
	...
	<td><form method="POST" action="supprimerProduit.php" enctype="multipart/form-data">
<div href="#" >
<input  type="submit" name="supprimer" value="Supprimer">
	...
	<a href="modifierProduit.php?idproduit=<?PHP echo $row['idproduit']; ?>">	<i class="fa fa-pencil"></i></a>
</td>
<?PHP
}
?>
