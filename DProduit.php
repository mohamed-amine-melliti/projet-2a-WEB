...
<!-- Mirrored from demo.devitems.com/pander-v3/product-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Feb 2019 08:48:43 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Product Details || Pander Furniture Ecommerce Bootstrap 4 Template</title>
                        ...
                        <div class="col-xl-12 ">
                            <nav>
                                <ul class="header-bottom-list d-flex">
                                    <li class="active"><a class="drop-icon" href="home-6.html">home</a>
                                        <!-- Home Version Dropdown Start -->
                                        <ul class="ht-dropdown">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-6 mb-all-40">
                        ...
                        <div class="tab-content">
                            <div id="thumb1" class="tab-pane fade show active">
                                <a data-fancybox="images" href=""><?PHP echo "<img src='images/".$row['image']."' >"; ?></a>
                            </div>
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="thubnail-desc fix">
                            <h3 class="product-header"><?PHP echo $row['nomproduit']; ?></h3>
                            ...
                            <div class="pro-thumb-price mt-10">
                                <p class="d-flex align-items-center"><span class="price"><?PHP echo $row['prix']; ?> DT</span></p>
                            </div>
                            <p class="pro-desc-details"><?PHP echo $row['description']; ?></p>
                ...
                <div class="our-pro-active owl-carousel">
                    ...
                    <div class="single-pander-product">
                        ...
                        <div class="pro-content">
                            ...
                            <p><span class="price">DT45.50</span></p>
                    ...
                    <div class="single-pander-product">
                        ...
                        <div class="pro-content">
                            ...
                            <p><span class="price">DT65.00</span></p>
                            <div class="pro-actions">
                                <div class="actions-primary">
                                    <a href="cart.html" class="add-to-cart" data-toggle="tooltip" data-original-title="Add to Cart">Add To Cart</a>
                                </div>
                    ...
                    <div class="single-pander-product">
                        ...
                        <div class="pro-content">
                            ...
                            <p><span class="price">DT61.21</span><span class="prev-price">DT64.50</span></p>
                            <div class="pro-actions">
                                <div class="actions-primary">
                                    <a href="cart.html" class="add-to-cart" data-toggle="tooltip" data-original-title="Add to Cart">Add To Cart</a>
                                </div>
                    ...
                    <div class="single-pander-product">
                        ...
                        <div class="pro-content">
                            ...
                            <p><span class="price">DT72.50</span></p>
                            <div class="pro-actions">
                                <div class="actions-primary">
                                    <a href="cart.html" class="add-to-cart" data-toggle="tooltip" data-original-title="Add to Cart">Add To Cart</a>
                                </div>
                    ...
                    <div class="single-pander-product">
                        ...
                        <div class="pro-content">
                            ...
                            <p><span class="price">DT55.50</span><span class="prev-price">DT59.50</span></p>
                            <div class="pro-actions">
                                <div class="actions-primary">
                                    <a href="cart.html" class="add-to-cart" data-toggle="tooltip" data-original-title="Add to Cart">Add To Cart</a>
                                </div>
