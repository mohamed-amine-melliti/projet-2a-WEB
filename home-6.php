                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 mb-sm-30">
                        <div class="single-banner zoom">
                            <a href="shop.php"><img src="img/banner/b8.jpg" alt="banner-img"></a>
                        </div>
                    </div>
                    <div class="col-lg-5 col-md-5 mb-sm-30">
                        <div class="single-banner zoom">
                            <a href="shop.php"><img src="img/banner/b9.jpg" alt="banner-img"></a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4">
                        <div class="single-banner zoom">
                            <a href="shop.php"><img src="img/banner/b10.jpg" alt="banner-img"></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 mb-sm-30">
                        <div class="single-banner zoom">
                            <a href="shop.php"><img src="img/banner/b11.jpg" alt="banner-img"></a>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="single-banner zoom">
                            <a href="shop.php"><img src="img/banner/b12.jpg" alt="banner-img"></a>
                        </div>
                    </div>
                </div>
            </div>
