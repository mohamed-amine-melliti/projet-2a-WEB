...
<?PHP
                ...
                $Produit2C=new categorieC();
                $listeProduits=$Produit1C->afficherProduits();
                $listeProduits1=$Produit2C->affichercats();

				?>
<html class="no-js" lang="zxx">


<!-- Mirrored from demo.devitems.com/pander-v3/shop.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Feb 2019 08:48:42 GMT -->
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-5  col-sm-7 order-2 order-lg-3">
                            <div class="cart-box">
                                <ul class="d-flex justify-content-sm-between  align-items-center">
                                    ...
                                    <li><a href="#"><img src="img/vertical-menu/icon_cart.png" alt="cart-icon"><span
                                                class="total-pro">2</span><span class="my-cart"><span>my
                                                    cart</span></span></a>
                ...
                <div class="row">
                    ...
                    <div class="search-filter mb-30">
                      ...
                      <div id="slider-range1"></div>
                                    ...
                                    <input type="text" id="amount1" class="amount-range" name="amount1"  >
...
<br>
                              <div id="slider-range"></div>
                                    <input type="text" id="amount" class="amount-range" name="amount"  >
...
<select name=cate>
                                       <?PHP
foreach($listeProduits1 as $col){
?>

<option value="<?PHP echo $col['cat']; ?>">
                                                <?PHP echo $col['cat']; ?></label>
...
<div>
<button mat-button>recherche</button>
</div>
                        <!-- Single Banner Start -->
                        <div class="sidebar-banner mt-30">
                            <a href="shop.php"><img class="ful" src="img/banner/b14.jpg" alt="slider-banner"></a>
                        </div>
                    ...
                    <div class="col-lg-9 order-1 order-lg-2">
                        <div class="shop-banner mb-40">
                            <a href="shop.php"><img src="img/banner/b18.jpg" alt="banner-img"></a>
                        </div>
                        <!-- Grid & List View Start -->
                        <div
                            class="list-top border-default universal-padding d-md-flex justify-content-md-between align-items-center mb-30">
...
?>
                            ...
                            <div class="single-pander-product">
                                <div class="pro-img">
                                    <a href="DProduit.php?idproduit=<?PHP echo $col['idproduit']; ?>">
                                        <?PHP echo "<img src='images/".$col['image']."' >"; ?></a>
                                ...
                                <td>
                                    <div class="pro-content">
                                        ...
                                        <h4 class="pro-title"><a
                                                href="DProduit.php?idproduit=<?PHP echo $col['idproduit']; ?>">
                                                <?PHP echo $col['nomproduit']; ?></a></h4>
                                        <p><span class="price">
                                                <?PHP echo $col['prix']; ?> DT</span></p>
                                        <p>
                                            <?PHP echo $col['description']; ?>
                                        </p>
                                        <div class="pro-actions">
                                            <div class="actions-primary">
                                                <a href="cart.php?id=<?PHP echo $col['idproduit']; ?>" class="add-to-cart" data-toggle="tooltip"
                        ...
                        <div class="col-lg-6 mb-all-40">
                            <div class="twitter-post">
                                ...
                                <div class="twitter-content">
                                    <div class="twitter-user"><a href="#">Example themes Club</a> <a
                                            href="#">@demothemes</a></div>
                                    <div class="twitter-desc">
                                        <p>Check out "pander - Furniture ecommerce #HTML #Template" <br> on #Envato by
                                            <a href="#">@exampletheme</a> #Themeforest <a href="#">you twitter link
                                            </a><br><span class="tweet-time"><a href="#">23 Sep</a></span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!-- Mirrored from demo.devitems.com/pander-v3/shop.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Feb 2019 08:48:43 GMT -->
