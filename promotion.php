                                    ...
                                    <!-- Single Product Start Here -->
                                        ...
                                        <div class="pro-img">
                                            ...
                                            <div class="quick-view-pro">
                                                <a><?PHP echo "<img src='images/".$P['image']."' >"; ?></a>
                                            </div>
                                        </div>
</td>
<td ></td>
...
<td >
                                        <center>
                                            ...
                                            <h1 ><?PHP echo $P['nompromo']; ?></h1>
                                            <h2 color="red"><?PHP echo $P['pourcentage']; ?> % </h2>
                                            <h3> <?PHP echo $P['datefin']; ?></h3>
                                            <h3> <?PHP echo $P['datedebut']; ?></h3>
