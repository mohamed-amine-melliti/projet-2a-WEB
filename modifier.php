...
<html class="fixed">
	<head>
		...
		<title>Editable Tables | B&B-Admin</title>
...
?>
<form method="POST">
<h2 class="panel-title">modifier commande</h2>
									</header>

									<div class="panel-body">
										
											<div class="form-group">
												<label class="col-md-3 control-label"> id commande</label>
												<div class="col-md-6">
<input type="number" name="idCmd" value="<?PHP echo $idCmd ?>">												</div>
											</div>
						
											<div class="form-group">
												<label class="col-md-3 control-label">date commande</label>
												<div class="col-md-6">
<input type="text" name="dateCmd" value="<?PHP echo $dateCmd ?>">												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label">prix total commande</label>
												<div class="col-md-6">
<input type="text" name="prixtot" value="<?PHP echo $prixtot ?>">												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label">date prevu</label>
												<div class="col-md-6">
<input type="text" name="date_prev" value="<?PHP echo $date_prev ?>">												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label">etat commande</label>
												<div class="col-md-6">
<input type="text" name="etatCmd" value="<?PHP echo $etatCmd ?>">												</div>
											</div>
											<div>
<input type="submit" name="modifier" value="modifier">
</div>
<div>
<input type="hidden" name="idCmd_ini" value="<?PHP echo $_GET['idCmd'];?>">
...
if (isset($_POST['modifier'])){
	...
	?>
	<script>
		location.replace("affichercommande1.php");
