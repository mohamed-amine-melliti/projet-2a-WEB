					...
					<!-- start: page -->
						<section class="panel">
							...
							<div class="table-responsive">
								...
								<form method="POST" action="rechercheoffre.php">
								<div>
									recherche d'une offre selon le nom :<input class="form-control" type="text" name="srch" id="q">
...
?>
								<table class="table table-bordered table-striped mb-none" id="myTable2">
									<thead>
										<tr>
												<th onclick="sortTable(0)">codepromo</th>
												<th>descripition</th>
												<th>pourcentage</th>
												<th>datefin</th>
												<th>supprimer</th>
									...
									<tbody>
										<tr class="gradeX">
												...
												foreach($listeoffres as $row){
													...
													<td><form method="POST" action="supprimeroffre.php" enctype="multipart/form-data">
													<input type="submit" class="btn btn-primary" name="supprimer" value="supprimer">
													<input type="hidden" value="<?PHP echo $row['codepromo']; ?>" name="codepromo">
													</form>
													</td>
													<td><a href="modifieroffre.php?codepromo=<?PHP echo $row['codepromo']; ?>">
													Modifier</a></td>
